...
export default function MetricCard({ title, value, icon: Icon, trend, color = 'emerald' }) {
    const colors = {
    ...
    return (
        <motion.div
            ...
            className="bg-white rounded-[28px] p-6 border border-slate-100 shadow-sm hover:shadow-xl hover:shadow-green-900/5 transition-all group"
        >
